...
const MOD_DIR := "wankers-wheelchairwankers" # Name of the directory that this file is in
const LOG_NAME := "wankers-wheelchairwankers:Main" # Full ID of the mod (AuthorName-ModName)
